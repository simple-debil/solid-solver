...
set dgrid3d  32, 32,  4
set table $Gridded_sigmaEqv
splot fn_2d_sigmaEqv
unset table
unset dgrid3d
...
set output fn_out
set multiplot
splot $Gridded_sigmaEqv with lines dt 2 lc rgb 'black' notitle
splot $Gridded_sigmaEqv with labels boxed notitle
unset multiplot
