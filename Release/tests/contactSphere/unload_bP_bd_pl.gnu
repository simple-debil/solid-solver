...
plot \
fn_unload_bP_bd        with points pointtype 6 ps S*1 lw S*1.0 lc rgb 'black' title 'unload\_bP_{numb}', \
fn_unload_bP_bd_analit with lines lw S lt 1 dt 1 lc rgb 'black' title 'unload\_bP_{analit}'
