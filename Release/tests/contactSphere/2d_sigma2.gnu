...
set cntrparam levels discrete -0.4, -0.1, -0.025, 0.0, 0.008
...
set output fn_out
set multiplot
splot $Gridded_sigma2 with lines dt 2 lc rgb 'black' notitle
#splot $Gridded_sigma2 with labels boxed notitle
splot sigma2(r*a,-z*a) with lines lc rgb 'black' notitle #title '{/Symbol s}_{}'
splot sigma2(r*a,-z*a) with labels boxed notitle
unset multiplot
