...
plot \
fn_load_sigma_r with points pointtype 7 ps S*.2 lw S*1 lc rgb 'black' notitle, \
fn_unload_sigma_r with points pointtype 7 ps S*.2 lw S*1 lc rgb 'black' notitle, \
fn_load_sigma_r_analit with lines lw S lt 1 dt 1 lc rgb 'black' notitle, \
fn_unload_sigma_r_analit with lines lw S lt 1 dt 1 lc rgb 'black' notitle
