...
set cntrparam levels discrete -1.2, -0.8, -0.4, -0.2, -0.1, -0.05, 0.0
...
set output fn_out
set multiplot
splot $Gridded_sigma3 with lines dt 2 lc rgb 'black' notitle
#splot $Gridded_sigma3 with labels boxed notitle
splot sigma3(r*a,-z*a) with lines lc rgb 'black' notitle #title '{/Symbol s}_{}'
splot sigma3(r*a,-z*a) with labels boxed notitle
unset multiplot
