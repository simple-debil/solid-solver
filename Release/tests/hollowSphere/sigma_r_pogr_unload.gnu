...
set output "./tests/hollowSphere/sigma_r_pogr_unload.png"
set size ratio 1

plot\
"./tests/hollowSphere/unload_sigma_r_pogr.txt" with points pointtype 7 ps S*.2 lw S*1 lc rgb 'black' title '{/Symbol D}{/Symbol s}_r / {/Symbol s}_r{/Symbol \264}100%'
