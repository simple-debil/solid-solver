...
#fn_sigma_fi_analit using 1:2 with lines lw S lt 1 dt 2 lc rgb 'black' notitle


#пластичность:
#plot \
#fn_sigma_fi with points pointtype 7 ps S*.2 lw S*1 lc rgb 'black' notitle, \
#fn_sigma_fi_analit using 1:2 with lines lw S lt 1 dt 1 lc rgb 'black' notitle
...
fn_sigma_fi with points pointtype 7 ps S*.2 lw S*1 lc rgb 'black' notitle, \
fn_sigma_fi_analit using 1:2 with lines lw S lt 1 dt 2 lc rgb 'black' notitle, \
fn_sigma_fi_analit using 1:3 with lines lw S lt 1 dt 1 lc rgb 'black' notitle
