...
set output "./tests/hollowSphere/sigma_fi_pogr_load.png"
set size ratio 1

plot\
"./tests/hollowSphere/load_sigma_fi_pogr.txt" with points pointtype 7 ps S*.2 lw S*1 lc rgb 'black' title '{/Symbol D}{/Symbol s}_{/Symbol f} / {/Symbol s}_{/Symbol f}{/Symbol \264}100%'
